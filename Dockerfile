...
# Install.
RUN apt-get update && apt-get install -y cluster-glue heartbeat libffi-dev libssl-dev postgresql-9.3 postgresql-client-9.3 postgresql-contrib-9.3 postgresql-9.3-postgis-2.1 python python-dev python-pip
